...
## Design System Local Agent Contract

Before creating, changing, or consuming Echelon UI, read [docs/agents/DESIGN-SYSTEM-USAGE.md](docs/agents/DESIGN-SYSTEM-USAGE.md).
...
The published showcase is a discovery and teaching surface. Canonical source files and manifests remain authoritative.
